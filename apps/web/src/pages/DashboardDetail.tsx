...
import type { Todo } from '@vite-hono/shared'
...
export function DashboardDetail() {
  ...
  const configFields: { label: string; value: string | null; full: boolean; copy: boolean }[] = todo ? [
    ...
    { label: 'ID', value: todo.id, full: false, copy: false },
    { label: 'Created At', value: formatDate(todo.created || null), full: false, copy: false },
  ] : []
